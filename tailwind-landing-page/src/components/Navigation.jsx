  ...
  return (
    <nav className="relative container mx-auto p-6">
      ...
      <div className="md:hidden">
        ...
        <div
          id="menu"
          className="absolute z-50 flex flex-col items-center py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md rounded-lg"
        >
          <a href="#">Pricing</a>
          <a href="#">Product</a>
          <a href="#">About Us</a>
